...
- 非就业强相关但是很重要的书籍：
  - 《Computer Systems: A Programmer's Perspective》
    - 事实上：我并没有在大一完成这本书的学习，而是在大二上复习计组时发觉其重要性的。
    - 其中提及的许多概念对理解Jvm原理与Juc原理颇有益处。如果你对CSAPP有比较好的掌握，我相信你学习《深入理解Java虚拟机》的过程会惬意许多。
    - 我推荐你将这本书的学习列入每日学习计划，如果能在投递第一份实习之前完成，是最好不过的。
  - 未完待续...
...
- 大二上学期：
  ...
  - 考量到每日学习的知识点过于繁多，按月度总结在Readme部分很难实现。
  - 如果你希望了解一个具体的学习路径，你可以下载我的日报文件，我会定期更新这份日报，希望我的路径可以为你的路径寻觅提供一些微薄的作用。
